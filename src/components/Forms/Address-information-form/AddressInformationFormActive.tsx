export function AddressInformationFormActive() {
  return (
      ...
      <div className="row mt-3">
        <div className="col">
          ...
          <div className="dropdown">
            <button
              className="btn btn-default bg-transparent dropdown-toggle w-100 d-flex flex-row justify-content-between align-items-center"
              type="button"
